...
public class bankmanagement { // these class provides all
		...
		throws SQLException // transfer money method
	{
        ...
        public static void getDeposit(int acNo) throws SQLException {
    try {
        // Query
        ...
        if (rs.next()) { // Move the cursor to the first row
            ...
            deposit = Integer.parseInt(sc.readLine());

            int balance = rs.getInt("balance");
            balance += deposit;

            // Update the balance in the database
            sql = "update customer set balance=" + balance + " where ac_no=" + acNo;
            st.executeUpdate(sql);

            System.out.println("Amount deposited successfully!");
            System.out.println("After updating,the current balance: " + balance);
        } else {
